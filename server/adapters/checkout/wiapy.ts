// TODO: formato de payload não confirmado — confirmar com a doc oficial da Wiapy
...
export const wiapy: CheckoutAdapter = {
  verifySignature(req: Request, secret: string): boolean {
    console.warn(
      "wiapy adapter: signature validation not implemented — payload format not yet confirmed. " +
